...
export function MoodPicker({ value, onChange }: MoodPickerProps) {
  return (
    <div className="flex gap-1.5" role="group" aria-label="Настроение">
      {MOODS.map((mood) => (
        <button
          key={mood}
          type="button"
          ...
          className={`flex items-center justify-center size-9 rounded-xl text-lg transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent-soft ${
