      ...
      <GlassCard className="flex flex-col gap-4">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-white/40">В MVP доступна только тёмная тема</p>
          </div>
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-white/40">Влияет на будущие модули (Привычки)</p>
          </div>
          {settings && (
            <Select
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-white/40">Для Финансов и Дневника, появится позже</p>
          </div>
          <span className="text-xs rounded-full px-2.5 py-1 bg-white/[0.06] text-white/40">Скоро</span>
        </div>
      </GlassCard>
